    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cliente",
                columns: new[] { "IdCliente", "Clave", "Correo", "Documento", "Nombre", "NombreUsuario", "Telefono", "TipoDocumento" },
                values: new object[] { 1, "1234", "cliente@gmail.com", "999999999", "Alvaro Hernandez", "admin", "809-999-9999", "Cedula" });

            migrationBuilder.InsertData(
                table: "TipoAlquiler",
                columns: new[] { "IdTipoAlquiler", "Descripcion", "Dias" },
                values: new object[] { 1, "Mensual", 30 });

            migrationBuilder.InsertData(
                table: "TipoInmueble",
                columns: new[] { "IdTipoInmueble", "Descripcion" },
                values: new object[] { 1, "Departamento" });
            ...
            migrationBuilder.InsertData(
                table: "TipoMoneda",
                columns: new[] { "IdTipoMoneda", "Descripcion" },
                values: new object[] { 1, "Pesos Dominicanos" });
